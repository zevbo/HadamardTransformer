...
theory_cuda_home = os.environ.get("CUDA_HOME")
print(f"{theory_cuda_home = }, {os.path.exists(theory_cuda_home) = }")
print(f"{cpp_extension.CUDA_HOME = }")
print(f"{cpp_extension._find_cuda_home() = }")
...
with open(current_file / "README.md", "r", encoding="utf-8") as fh:
...
if not SKIP_CUDA_BUILD:
    ...
    if CUDA_HOME is not None:
        ...
        print(f"Cuda home is NONE {os.environ.get('CUDA_HOME')}")
